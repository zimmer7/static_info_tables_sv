...
class ext_update  {
    ...
    function main()    {
        ...
        if (t3lib_div::_GP('import')) {
            ...
            $extPath = t3lib_extMgm::extPath('static_info_tables_sv');
        ...
        } elseif (t3lib_extMgm::isLoaded('static_info_tables_sv')) {
     ...
     *
     * @param string $query Update statement like: UPDATE static_countries SET cn_short_sv='XXX' WHERE cn_iso_2='DE';
...
// Include extension?
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/static_info_tables_sv/class.ext_update.php'])    {
    include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/static_info_tables_sv/class.ext_update.php']);
}
